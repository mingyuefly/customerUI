...
@interface GMCropImageViewController ()
...
@implementation GMCropImageViewController
...
{
    GMCropImageViewController *civc = [self init];
    if (civc) {
...
-(UIButton *)conformButton
{
    if (!_conformButton) {
        ...
        [_conformButton setTitle:@"确定" forState:UIControlStateNormal];
